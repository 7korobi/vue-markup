...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__marked_vue__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dagre_vue__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__marksvg_vue__ = __webpack_require__(22);
  ...
  return _c("article", [
    _vm._ssrNode(
      "<svg" +
        ...
        _vm._ssrList(_vm.rects, function(o, key) {
          return o ? "<rect" + _vm._ssrAttrs(o) + "></rect>" : "<!---->"
        }) +
        _vm._ssrList(_vm.images, function(o, key) {
          return o ? "<image" + _vm._ssrAttrs(o) + "></image>" : "<!---->"
        }) +
        "</g><g>" +
        _vm._ssrList(_vm.paths, function(o, key) {
          return o
            ? '<path fill="none"' + _vm._ssrAttrs(o) + ' class="path"></path>'
            : "<!---->"
        }) +
        _vm._ssrList(_vm.texts, function(o, key) {
          return o
            ? "<text" +
                _vm._ssrAttrs(o) +
                ' class="messageText">' +
