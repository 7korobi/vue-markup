...
var Dagre, Marked, dic;

Marked = __webpack_require__(6).default;
  ...
  return _c(
    ...
    [
      _vm._ssrNode(
        ...
        [
          _vm._ssrNode(
            '<marker id="svg-marker-circle" viewBox="0 0 10 10" markerUnits="userSpaceOnUse" markerWidth="20" markerHeight="20" refX="2" refY="5" orient="auto" class="edgePath" data-v-42a55e88><circle cx="5" cy="5" r="4" data-v-42a55e88></circle></marker><marker id="svg-marker-arrow-start" viewBox="0 0 10 10" markerUnits="userSpaceOnUse" markerWidth="20" markerHeight="20" refX="3" refY="5" orient="auto" class="edgePath" data-v-42a55e88><path d="M10,0 L0,5 L10,10 z" class="path" data-v-42a55e88></path></marker><marker id="svg-marker-arrow-end" viewBox="0 0 10 10" markerUnits="userSpaceOnUse" markerWidth="20" markerHeight="20" refX="3" refY="5" orient="auto" class="edgePath" data-v-42a55e88><path d="M0,0 L10,5 L0,10 z" class="path" data-v-42a55e88></path></marker><marker id="svg-marker-cross" viewBox="0 0 10 10" markerUnits="userSpaceOnUse" markerWidth="20" markerHeight="20" refX="5" refY="5" orient="0" class="edgePath" data-v-42a55e88><path d="M0,0 L10,10 M0,10 L10,0 z" class="path" data-v-42a55e88></path></marker>'
          ),
          _c(
            "transition-group",
      ...
      _vm._ssrNode(
        _vm.graph.errors.length
          ? '<div class="errors" data-v-42a55e88>' +
            _vm._ssrList(_vm.graph.errors, function(err) {
              return (
                '<div class="error" data-v-42a55e88>' +
                _vm._ssrEscape(_vm._s(err)) +
                "</div>"
              )
            }) +
            "</div>"
